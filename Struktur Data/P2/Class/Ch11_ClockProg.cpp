...
int main(){
    ...
    yourClock.setTime(5, 4, 30);                      //Line 8
    ...
    if (myClock.equalTime(yourClock)){                    //Line 12
        ...
        cout << "Line 15: The two times are not equal." << endl; //Line 15
    }
    ...
    cout << "Line 24: After incrementing myClock by one second, myClock: ";                   //Line 24
    ...
    cout << "Line 28: hours = " << hours << ", minutes = " << minutes << ", seconds = " << seconds << endl;         //Line 28
    // printf("Line 28 : hours = %d, minutes = %d, second = %d", hours, minutes, seconds);
